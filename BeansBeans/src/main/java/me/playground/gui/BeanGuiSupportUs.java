...
public class BeanGuiSupportUs extends BeanGui {
	...
	public void onInventoryOpened() {
		...
		contents[4] = newItem(tpp.getSkull(), tpp.getColouredName(), Component.text("\u00a77You have \u00a7r" + tpp.getCrystals() + " Crystals\u00a77!").colorIfAbsent(BeanColor.CRYSTALS).decoration(TextDecoration.ITALIC, false));
		
		contents[10] = newItem(new ItemStack(Material.AXOLOTL_BUCKET), Component.text("Voting", BeanColor.CRYSTALS), 
				...
				Component.text("\u00a77You also receive \u00a7rCrystals\u00a77 and \u00a76Coins\u00a77 for voting!").colorIfAbsent(BeanColor.CRYSTALS).decoration(TextDecoration.ITALIC, false),
				Component.empty(),
				Component.text("\u00a77You've voted \u00a7r" + tpp.getStat(StatType.VOTING, "votes") + " \u00a77times!").colorIfAbsent(BeanColor.CRYSTALS).decoration(TextDecoration.ITALIC, false),
		...
		contents[16] = newItem(new ItemStack(Material.GOLDEN_APPLE), Component.text("Donating", BeanColor.CRYSTALS), 
				Component.text("\u00a7cCurrently unavailable."));
		
		contents[22] = newItem(new ItemStack(Material.CRAFTING_TABLE), Component.text("Playing", BeanColor.CRYSTALS), 
		...
		contents[29] = newItem(new ItemStack(Material.DIAMOND_HELMET), Component.text("Helping", BeanColor.CRYSTALS), 
		...
		contents[33] = newItem(new ItemStack(Material.CAKE), Component.text("Reporting Bugs", BeanColor.CRYSTALS), 
		...
		contents[40] = newItem(new ItemStack(Material.ANVIL), Component.text("Following the Rules", BeanColor.CRYSTALS), 
		...
		contents[48] = newItem(new ItemStack(Material.KNOWLEDGE_BOOK), Component.text("What is this?", BeanColor.CRYSTALS), "", 
